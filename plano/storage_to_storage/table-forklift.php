            ...
            // Fetch each row in an associative array
              ...
              switch ($row['spb_hari_tertunda']) {
                ...
                case 0:
                  ...
                  if ($row['spb_hari_tertunda'] >= 2) {
                     $infoTertunda = '<span class="label label-danger"> ' . $row['spb_hari_tertunda'] . ' jam yang lalu</span>';
                  } elseif ($row['spb_hari_tertunda'] == 1) {
                    $infoTertunda = '<span class="label label-primary"> ' . $row['spb_hari_tertunda'] . ' jam yang lalu</span>';
                  } elseif ($row['spb_hari_tertunda'] == 0) {
                    $infoTertunda = ' ';
                  }
                  break;
                case 1:
