    ...
    <article class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-xs-6">
          ...
          <h2>Storage ke Storage<br><small>belum diturunkan oleh Forklift</small>
          ...
          <h2>
            ...
            <?php 
              ...
              if ($spbBelumRealisasi > 0) {
                echo '<a href="../storagetostorage-belum-realisasi" class="btn btn-default btn-sm pull-right bayang" role="button">';
                echo '<span class="badge">';
                echo $spbBelumRealisasi; 
                echo '</span> Penurunan belum direalisasi Pramuniaga</a>';
              }
            ?>
