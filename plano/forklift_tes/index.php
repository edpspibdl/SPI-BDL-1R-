    ...
    <article class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-xs-6">
          ...
          <h2>SPB Storage ke Display <br><small>belum diturunkan oleh Forklift</small>
          ...
          <h2>
            ...
            <?php 
              ...
              if ($spbBelumRealisasi > 0) {
                echo '<a href="../forklift-belum-realisasi" class="btn btn-default  pull-right bayang" role="button">';
