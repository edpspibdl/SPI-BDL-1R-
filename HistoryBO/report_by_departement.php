...
SELECT
  ...
  SUM(trn_qty_bonus1) + SUM(trn_qty_bonus2) AS trn_qtybonus,
...
FROM (
  ...
  LEFT JOIN tbmaster_supplier AS s ON m.mstd_kodesupplier = s.sup_kodesupplier
  WHERE m.mstd_recordid IS NULL
) AS bo
WHERE trn_tgldoc BETWEEN :tglMulai AND :tglSelesai
";

// Tambahkan filter jenis transaksi jika tidak "All"
...
<section class="section">
    <div class="section-header d-flex justify-content-between">
        <h1>History BackOffice Per Dept</h1>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="table-1">
                            ...
                            <tbody>
                                <?php
                                $noUrut = 1;
                                $rphGross = $rphDiscount = $rphNetto = $rphPPN = $rphTotal = $jumlahItem = 0;
                                ...
                                if (empty($data)) :
                                    ...
                                    foreach ($data as $row) :
                                        ...
                                        echo '<td align="center">' . ($row['trn_dept'] ?? '-') . '</td>';
