        ...
        <button id="notifBtbBtn" class="btn btn-danger btn-lg btn-fixed-width ml-2">
            ...
            <div class="row ml-3 mr-3">
                ...
                <div class="col-md-6">
                    ...
                    <h6 class="mb-3">Laporan Tambahan (Month End)</h6>
                    <table class="table table-sm table-striped table-bordered mb-4" style="border: 2px solid black;">
                        <thead>
                            <tr>
                                <th style="width: 5%; text-align: center;">No</th>
                        ...
                        <tbody>
                            <?php
                            // Daftar Laporan Tambahan yang dapat diunduh
                            $additionalReports = [
                            ...
                            // Gabungkan URL dari Laporan Tambahan ke array allReportUrls untuk tombol "Download Semua"
                            foreach ($additionalReports as $report) {
                                $reports[] = $report; // Gabungkan ke reports utama agar JS di bawah juga ikut mengunduh
                            }

                            foreach ($additionalReports as $i => [$name, $btnClass, $urls]) {
                                echo "<tr>
                                        <td style='text-align: center;'>" . ($i + 1) . "</td>
                                        <td>$name</td>
                                        <td>";
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const allReportUrls = [];
        <?php
        // Loop ulang array $reports yang sekarang sudah termasuk $additionalReports
        ...
        // Event listener tombol download individual (berlaku untuk semua tombol dengan class .download-button)
