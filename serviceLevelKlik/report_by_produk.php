...
<section class="section">
    <div class="section-header d-flex justify-content-between">
        <h3 style="margin-bottom: 0;">
            ...
            <span style="font-weight: normal; font-size: 1rem; color: #6c757d;">per Produk</span>
                        ...
                        <table class="table table-hover table-striped" id="table-1">
                            <thead>
                                ...
                                <tr class="info">
                                    ...
                                    <th colspan="5" align="center">Produk</th>
                                    <th colspan="3" align="center">Qty</th>
                                    <th colspan="3" align="center">Rupiah</th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($result as $row):
                                    ...
                                    echo '<td align="center">' . $row['slk_k_d'] . '</td>';
                                    echo '<td align="center">' . $row['slk_k_dept'] . '</td>';
                                    echo '<td align="center">' . $row['slk_katb'] . '</td>';
                                    echo '<td align="center">' . $row['slk_prdcd_ctn'] . '</td>';
                                    echo '<td align="left">' . $row['slk_namabarang'] . '</td>';
