                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="jenis" name="jenis" required>
                                        ...
                                        <option value="div">Per Divisi</option>
                                        <option value="dept">Per Departement</option>
                                        <option value="kat">Per Kategori</option>
                                        <option value="member">Per Member</option>
                                        <option value="produk">Per Produk</option>
                                        <option value="produk_detail">Per Produk Detail</option>
                                        <option value="supp">Per Supplier</option>
                                        <option value="kdtag">Per KD TAG</option>
                                    </select>
                                </div>
...
<script>
    document.getElementById('formReport').addEventListener('submit', function(e) {
        ...
        if (jenis === 'member') {
            ...
            window.location.href = 'report_by_kdtag.php?' + params;
        }
